...
namespace music_manager_starter.Data.Migrations
{
    ...
    [Migration("20241030014013_ChangePlaylistToString")]
    partial class ChangePlaylistToString
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("music_manager_starter.Data.Models.Playlist", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c810c3ae-6baa-4eec-babe-748c6457bbcc"),
                            Name = "Default playlist",
                            Songs = "[\"Viva la Vida\",\"Yellow\",\"Shiver\"]"
                        });
                });
